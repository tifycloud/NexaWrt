...
grep -Fq "workflows: ['NexaWrt AX9000 reproducible RAM-test release', 'NexaWrt x86_64 VM release', 'Promote ESXi-accepted VM RC', 'NexaWrt signed APK package repository']" "$WORKFLOW"
...
grep -Fq 'refusing to deploy Pages without the locked repository' "$WORKFLOW"
